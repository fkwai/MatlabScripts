...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function Set_Parameter_Table2(ParamTable)
global Parameter_Table 
global ScreenDiag

switch ParamTable
   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   %  GLDAS NOAH1 parameter table   gribtab_GLDAS_NOAH_sorted.tab   %
   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    case 'gribtab_GLDAS_NOAH_sorted'
      Parameter_Table={...
      {'var0','undefined',''},...
      ...
      {'-',   'Unused ',   '-'},...
      {'Rainfforc','Rainfall rate','kg/m^2/s'},...
      {'-',   'Unused ',   '-'},...
      {'-',   'Unused ',   '-'},...
      {'-',   'Unused ',   '-'},...
      {'-',   'Unused ',   '-'},...
      {'Snowfforc','Snowfall rate','kg/m^2/s'},...
      {'SWE','Snow Water Equivalent','kg/m^2'},... 
      {'-',   'Unused ',   '-'},...
      {'-',   'Unused ',   '-'},...
      {'DelSoilMoist','Change in soil moisture','kg/m^2'},...
      {'-',   'Unused ',   '-'},...
      ...
      {'-',   'Unused ',   '-'},...
      {'-',   'Unused ',   '-'},...
      {'DelSWE','Change in snow water equivalent','kg/m^2'},...
      {'-',   'Unused ',   '-'},...
      {'-',   'Unused ',   '-'},...
      {'-',   'Unused ',   '-'},...
      {'-',   'Unused ',   '-'},...
      {'-',   'Unused ',   '-'},...
      {'Albedo','Surface Albedo, All Wavelengths','-'},... 
      {'SoilTemp1','Average layer 1 soil temperature','K'},... 
      {'SoilTemp2','Average layer 2 soil temperature','K'},... 
      {'SoilTemp3','Average layer 3 soil temperature','K'},... 
      {'SoilTemp4','Average layer 4 soil temperature','K'},... 
      {'SoilMoist1','Average layer 1 soil moisture','kg/m^2'},...
      {'SoilMoist2','Average layer 2 soil moisture','kg/m^2'},...
      {'SoilMoist3','Average layer 3 soil moisture','kg/m^2'},...
      {'SoilMoist4','Average layer 4 soil moisture','kg/m^2'},...
      {'-',   'Unused ',   '-'},...
      {'-',   'Unused ',   '-'},...
      {'-',   'Unused ',   '-'},...
      {'-',   'Unused ',   '-'},...
  ...
  case 'ECMWF140'
      ...
      %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      %    ECMWF user-defined parameter table (#140)          %
      %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      ...
      {'MP2',   'Mean wave period based on second moment',   's'},...
      {'WDW',   'Wave spectral directional width',   '-'},...
      ...
      {'WSK',   'Wave spectral kurtosis',   '-',},...
      {'BFI',   'Benjamin-Feir index',   '-'},...
      {'WSP',   'Wave spectral peakedness',   's**-1'},...
      {'-',   'Indicates a missing value',   '-'}};
...
if ScreenDiag, disp(sprintf('Parameter Table set to %s',ParamTable))   , end
