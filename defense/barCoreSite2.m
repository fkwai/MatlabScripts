...
dirFigure=['/home/kxf227/work/defense/'];
    ...
    for j=1:length(pidPlotLst)
        ...
        for k=1:length(indSite)
            ...
            for i=1:length(fieldLst)
                ...
                tempStr.(field)=[temp;tempAdd([1,5,3,2,6])];
...
%         end
    ...
    fixFigure
    saveas(f,[dirFigure,'barPlot_CoreSite_',productName,'_','2.fig'])
    saveas(f,[dirFigure,'barPlot_CoreSite_',productName,'_','2.jpg'])
    saveas(f,[dirFigure,'barPlot_CoreSite_',productName,'_','2.eps'])
end
% fixFigure
