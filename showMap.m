...
[strTitle,shape,newFig,Position,lonLim,latLim,lonTick,latTick,...
    colorRange,nLevel,cmap,openEnds,insert0,...
    tsStr,tsStrFill,tsTitleGrid,setCBloc]=...
...
if isfield(landareas,'Lat')
    geoshow([landareas.Lat], [landareas.Lon], 'Color', 'k')
elseif isfield(landareas,'X')
    geoshow([landareas.Y], [landareas.X], 'Color', 'k')
end
