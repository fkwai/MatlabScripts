function [dataTrain,dataTest]= readRnnPred( outFolder,trainName,testName,epoch,timeOpt)
...
global kPath
testFolder=[outFolder,kPath.s,'out_',trainName,'_',testName,'_',num2str(epoch),kPath.s];
