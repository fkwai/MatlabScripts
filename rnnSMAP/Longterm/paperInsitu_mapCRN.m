...
if strcmp(siteName,'CRN')
    ...
    if strcmp(productName,'rootzone')
        [SMAP,LSTM]=readHindcastSite(siteName,'rootzonev4f1');
    else
...
fixFigure
saveas(f,[dirFigure,'mapCRN',productName,'.fig'])
saveas(f,[dirFigure,'mapCRN',productName,'.jpg'])
