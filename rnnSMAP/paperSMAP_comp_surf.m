...
[outTrainT,outT,covT]=testRnnSMAP_readData(outName,trainName,testNameT,epoch,'varLst','varLst_NOAH','readData',0);
...
statT_ARMA=statCal(matARMA.yARMA(367:732,ind),outT.ySMAP(:,ind));
...
[outTrainS,outS,covS]=testRnnSMAP_readData(outName,trainName,testNameS,epoch,'timeOpt',3,'varLst','varLst_NOAH','readData',0);
...
fname=[figFolder,'\','boxplot_surf_AMRA'];
