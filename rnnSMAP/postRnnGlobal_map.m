...
[rootOut,rootDB,targetName,modelField,mapTime,...
    tsTime,epoch,stat,colorRange,drBatch,stdLst,itemLst]=...
...
outMap=postRnnGlobal_load(outName,dataName,mapTime,'epoch',epoch,...
    'rootOut',rootOut,'rootDB',rootDB,'drBatch',drBatch,'targetName',targetName,'modelField',modelField);
crd=outMap.crd;
tnum=outMap.tnum;
