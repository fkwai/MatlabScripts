function [ Enew,Ebudyko,R2 ] = budykoReg_B_GRDC( GRDCstr,GRDCstr_t,b,varargin )
% regression of GRDCstr from a given b.
% varargin is a time array from which b is generated.
...
if opt_parstr==0
    [Enew,Ebudyko,R2,D]=budykoReg2_B(E,Ep,P,Ampf,[Acfd48,Pcfd48_2,Pcfd48_3,Amp1,Snow./P],b,parTP,1);
    %[Enew,Ebudyko,R2,b,D,AIC]=budykoReg2( E,Ep,P,Ampf,[Acfd48,Pcfd48_2,Pcfd48_3],[2,0],1 );
elseif opt_parstr==1
    cmdstr=['[Enew,Ebudyko,R2,D]=',parstr,];
    eval(cmdstr);
end
